 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_EXPLOSION, SFASSET_ALIEN, SFASSET_COIN, SFASSET_BRICKS};
...
public:
  ...
  virtual void      HandleCollision(std::shared_ptr<SFAsset>);
  virtual void		SetType(SFASSETTYPE);
